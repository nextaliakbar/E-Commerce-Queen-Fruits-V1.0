...
class CustomSingleChildListWidget extends StatefulWidget {
  ...
  CustomSingleChildListWidget({
    ...
    this.physics, this.controller, this.isWrap = false,
    this.wrapSpacing, this.runSpacing
  }) : assert(!(itemCount > 1000), "Jangan gunakan widget ini jika jumlah item anda banyak"), super(key: UniqueKey());

  @override
  State<StatefulWidget> createState()=> _CustomSingleChildListWidgetState();
}
